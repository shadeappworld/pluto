export default {
  ...
  strings: {
    ...
    fil_PH: {
      ...
      welcome_page1_header: "Maligayang pagdating sa ShadeOS",
      welcome_page1_body:
        "Kamusta! Maligayang pagdating sa ShadeOS, ang bagong 'desktop environment' para sa web.\n\nI-click ang 'Sunod' para sa setup.",
      ...
      welcome_page2_language_pt_BR: "Portuguese (Brazil)",
      welcome_page2_language_fil_PH: "Filipino (Pilipinas)",
      welcome_page3_header: "Baguhin ang hitsura ng ShadeOS",
